...
(function(){
  ...
  const i18n = {
    es: {
      ...
      'exp.dbsystem.role':'Desarrollador Backend <b>Go</b>',
      'exp.dbsystem.date':'ene. 2026 – actualidad · Remoto (Bogotá)',
      'exp.dbsystem.summary':'Diseño e implementación de microservicios REST en <b>Go</b> con enfoque en arquitectura hexagonal (Ports & Adapters), integraciones con bases de datos relacionales y sistemas financieros.',
      'exp.dbsystem.b1':'Implementación de arquitectura hexagonal estricta: separación entre dominio, casos de uso, puertos e infraestructura.',
      'exp.dbsystem.b2':'Patrones aplicados: Strategy, Repository, Builder, Middleware.',
      'exp.dbsystem.b3':'Diseño de contratos REST con migraciones breaking change coordinadas entre equipos consumidores.',
      'exp.dbsystem.b4':'Documentación técnica en formato RFC corporativo con casos de prueba y ejemplos curl.',
      'exp.dbsystem.b5':'APIs HTTP con Gin, binding y validación de DTOs, manejo de errores de dominio.',
      'exp.dbsystem.b6':'Integración con Oracle vía go-ora/v2 (driver puro Go, sin Instant Client), stored procedures con parámetros nombrados.',
      'exp.dbsystem.b7':'Integración con SQL Server vía go-mssqldb: TVP para inserts masivos en lote, validación de named instances post-conexión.',
      'exp.dbsystem.b8':'Cliente HTTP con OAuth2 client credentials flow, parsing robusto de respuestas de gateways externos.',
      'exp.dbsystem.b9':'Escritura de archivos sobre SMB v2 con autenticación NTLM (go-smb2).',
      'exp.dbsystem.b10':'Generación de archivos de ancho fijo (formato bancario legacy): padding, encoding, dígito verificador, fechas ACH.',
      'exp.dbsystem.b11':'Normalización y validación de datos financieros: códigos bancarios, homologación de productos entre sistemas.',
      'exp.dbsystem.b12':'Testing unitario con testify y mocks generados por interfaz; validación E2E contra entornos reales con curl y Postman.',
      'exp.dbsystem.b13':'Contenedores Docker multi-stage: builder Alpine → runtime scratch (binario estático, mínima superficie de ataque).',
      'exp.dbsystem.b14':'CI/CD con GitHub Actions, conventional commits con ! para breaking changes.',
      'exp.dbsystem.b15':'Gestión de parámetros y secretos en Kubernetes (NullPlatform): variables por ambiente QA/UAT/PROD.',
      'exp.dbsystem.b16':'Observabilidad con Datadog APM: tracing distribuido, profiler opcional, structured logging JSON.',
    ...
    en: {
      ...
      'about.body':'I am a web and mobile developer with 8+ years of experience. I have worked on corporate projects, full online stores and hybrid apps. Strong in <b>PrestaShop</b> and back end with <b>PHP/Node.js</b>, and currently building <b>microservices in Go</b>; complemented with modern front end. I also administer <b>Linux</b> (Nginx/Apache), handle <b>MySQL/PostgreSQL</b> and orchestrate deployments with <b>Ansible</b>. I like to leave things better than I found them: iterative refactors, performance measurement and frictionless security. I enjoy collaborating with diverse teams to build reliable, scalable and meaningful solutions.',
      ...
      'exp.dbsystem.role':'Backend <b>Go</b> Developer',
      'exp.dbsystem.date':'Jan 2026 – present · Remote (Bogotá)',
      'exp.dbsystem.summary':'Design and implementation of REST microservices in <b>Go</b> with a focus on hexagonal architecture (Ports & Adapters), integrations with relational databases and financial systems.',
      'exp.dbsystem.b1':'Strict hexagonal architecture: separation between domain, use cases, ports and infrastructure.',
      'exp.dbsystem.b2':'Applied patterns: Strategy, Repository, Builder, Middleware.',
      'exp.dbsystem.b3':'REST contract design with breaking-change migrations coordinated across consumer teams.',
      'exp.dbsystem.b4':'Technical documentation in corporate RFC format with test cases and curl examples.',
      'exp.dbsystem.b5':'HTTP APIs with Gin, DTO binding and validation, domain error handling.',
      'exp.dbsystem.b6':'Oracle integration via go-ora/v2 (pure Go driver, no Instant Client), stored procedures with named parameters.',
      'exp.dbsystem.b7':'SQL Server integration via go-mssqldb: TVP for batch bulk inserts, post-connection named instance validation.',
      'exp.dbsystem.b8':'HTTP client with OAuth2 client credentials flow, robust parsing of external gateway responses.',
      'exp.dbsystem.b9':'File writing over SMB v2 with NTLM authentication (go-smb2).',
      'exp.dbsystem.b10':'Fixed-width file generation (legacy banking format): padding, encoding, check digit, ACH dates.',
      'exp.dbsystem.b11':'Normalization and validation of financial data: bank codes, product mapping across systems.',
      'exp.dbsystem.b12':'Unit testing with testify and interface-generated mocks; E2E validation against real environments with curl and Postman.',
      'exp.dbsystem.b13':'Multi-stage Docker containers: Alpine builder → scratch runtime (static binary, minimal attack surface).',
      'exp.dbsystem.b14':'CI/CD with GitHub Actions, conventional commits with ! for breaking changes.',
      'exp.dbsystem.b15':'Parameter and secret management in Kubernetes (NullPlatform): per-environment variables QA/UAT/PROD.',
      'exp.dbsystem.b16':'Observability with Datadog APM: distributed tracing, optional profiler, structured JSON logging.',
